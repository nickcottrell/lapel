    meSpeak.speak("Hello, I am a robot.");
	...
	startBtn_BLEEP.click();
      ...
      var startRecording = function() {
		meSpeak.speak("Say something.");
		//add a time delay of 1.5 seconds so that it doesn't record the robot voice
		setTimeout(function() {
        ...
        spawnWorker("js/recognizer.js", function(worker) {
            ...
            worker.onmessage = function(e) {
                ...
                if (e.data.hasOwnProperty('hyp')) {
                  ...
                  //####HACKJOB####
				  //i removed the "Final" text and make it so it automatically clicks the stop button to end the input
				  //so far it doesn't like long strings
				  //newHyp = "Final: " + newHyp;
//				setTimeout(function() {
                  updateHyp(newHyp);
//				}, 0);
...
//					setTimeout(function() {
					if (newHyp != 0) { 
						...
						setTimeout(function() {
							if (newHyp == "GRAPE") {
								meSpeak.speak("congratulations. grape is the magic word.");
							} else {
...
//}, 1000);
      ...
      // This grammar recognizes fruits and was added by me
